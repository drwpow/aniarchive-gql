...
// prettier-ignore
const sakugaPosts = {
  'jin-roh': [118513, 118512, 118511, 66345, 66344, 66343, 66342, 66341, 66340, 66253, 66249, 66248, 66247, 66246, 66245, 66244, 66243, 66242, 66241, 48707, 48706, 48705, 48704, 48703, 48702, 48701, 48700, 48699, 48684, 48683, 48682, 48677, 48674, 48673, 48672, 48671, 48670, 48669, 48668, 48667, 48665, 48664, 48663, 48661, 48659, 48658, 48657, 48656, 48655, 48654, 48653, 48652, 48651, 48650, 48649, 48647, 48646, 48645, 48644, 48643, 48641, 48640, 48639, 48638, 48637, 48636, 48635, 42589, 42588, 42587, 42586, 42585, 42584, 42583, 42582, 42581, 42580, 42579, 18041, 18040, 11290, 1265],
  'lupin-the-third-the-castle-of-cagliostro': [8931, 16697, 16698, 16699, 34824, ...Array.from(new Array(15), (_, i) => i + 37513), 73328, 73329],
  'princess-mononoke': [13513, 16771, 16772, 16774, 16777, 16780, 16781, 16782, 16785, 67789, 67822, 67823, 67916, ...Array.from(new Array(43), (_, i) => i + 68061).filter(n => n !== 68090)],
};
...
const people: { [key: string]: Person } = {
  ...
  'inoue-toshiyuk': { lastName: 'Inoue', firstName: 'Toshiyuki', kanji: '井上 俊之', country: JP, animated: ['118513', '118512', '118511'] },
