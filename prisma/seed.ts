...
const films:{[key:string]:Film} = {
  ...
  'emperors-new-groove':{releaseYear:2000,studio:'disney-animation',title:'The Emperor’s New Groove',titleEN:'The Emperor’s New Groove',titleJP:'ラマになった王様'},
  ...
  'mulan':{releaseYear:1998,studio:'disney-animation',title:'Mulan',titleEN:'Mulan',titleJP:'ムーラン'},
  ...
  'prince-of-egypt':{releaseYear:1998,studio:'dreamworks-animation',title:'The Prince of Egypt',titleEN:'The Prince of Egypt',titleJP:'プリンス・オブ・エジプト'},
  'princess-mononoke':{releaseYear:1997,studio:'studio-ghibli',title:'もののけ姫',titleJP:'もののけ姫',titleEN:'Princess Mononoke'},
  'secret-of-nimh':{releaseYear:1982,studio:'don-bluth-productions',title:'The Secret of NIMH',titleEN:'The Secret of NIMH',titleJP:'ニムの秘密'},
...
const people:{[key:string]:Person} = {
  ...
  'baxter-james':{animated:[19896,19897,19898,29527,48648,48660],lastName:'Baxter',firstName:'James',birthYear:1967,birthMonth:5,country:'US'},
  ...
  'cleuzo-sandro':{animated:[34042],lastName:'Cleuzo',firstName:'Sandro',country:'US'},
  ...
  'pomeroy-john':{animated:[31067,31068,36475,36853,82170],lastName:'Pomeroy',firstName:'John',country:'US'},
