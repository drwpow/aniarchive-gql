# Migration `20200520000625-ghibli`

This migration has been generated by Drew Powers at 5/20/2020, 12:06:25 AM.
...
"id" TEXT NOT NULL  ,"imageId" TEXT NOT NULL  ,"releaseYear" INTEGER NOT NULL  ,"studioId" TEXT   ,"title" TEXT NOT NULL  ,"titleEN" TEXT NOT NULL  ,"titleES" TEXT NOT NULL  ,"titleJP" TEXT NOT NULL  ,"trailer" TEXT   ,
...
CREATE UNIQUE INDEX "quaint"."Film.titleES" ON "Film"("titleES")
